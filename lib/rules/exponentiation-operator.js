    ...
    return {
        ...
        if (left.type === 'Identifier' && left.name === name) {
          ...
          context.report({
            ...
            fix(fixer) {
              ...
              // the fix for the space-infix-ops rule
              // will undo the lack of spaces around **
              // unless its new noExpSpace option is specified.
      ...
      CallExpression(node) {
        ...
        context.report({
          ...
          message: 'prefer ' + text,
          fix(fixer) {
            console.log('exponentiation-operator.js fix: entered');
            return fixer.replaceText(node, text);
          }
        });
      }
